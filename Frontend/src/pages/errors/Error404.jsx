...
export default function Error404() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", height: "100vh", fontFamily: "'Outfit', 'Lato', sans-serif", textAlign: "center", padding: "20px" }}>
      ...
      <button style={{ background: "#004c06", color: "white", padding: "14px 28px", borderRadius: "12px", border: "none", fontWeight: "bold", fontSize: "16px", cursor: "pointer", boxShadow: "0 4px 12px rgba(0, 76, 6, 0.3)" }} onClick={() => navigate("/explorar")}>
        Tornar a l'inici
      </button>
    </div>
  );
